...
})[0];if((k.indexOf("on")!==0&&!(k.indexOf("the")===0&&k.indexOf(",",k.length-1)!==-1)&&o.indexOf(k,o.length-k.length-1)===-1)||(!(l&&l.isAllDay)&&k.length<=2&&k.match(d.hoursOnly))){return false;
...
if(i){if(l>i&&i>j&&l.getMonth()===i.getMonth()&&l.getDate()===i.getDate()&&l.getFullYear()===i.getFullYear()&&l.getMonth()===j.getMonth()&&l.getDate()===j.getDate()&&l.getFullYear()===j.getFullYear()){l.setDate(l.getDate()-1);
}else{if(i<j){if(i.getMonth()===j.getMonth()&&i.getDate()===j.getDate()&&i.getFullYear()===j.getFullYear()){if(!k){if(l<i&&l.getMonth()===j.getMonth()&&l.getDate()===j.getDate()&&l.getFullYear()===j.getFullYear()){l.setDate(l.getDate()+1);
}i.setDate(i.getDate()+1);}}else{if(l<i){l.setFullYear(l.getFullYear()+1);}i.setFullYear(i.getFullYear()+1);}}}}else{if(l){if(l<j){if(l.getMonth()===j.getMonth()&&l.getDate()===j.getDate()&&l.getFullYear()===j.getFullYear()){if(!k){l.setDate(l.getDate()+1);
}}else{l.setFullYear(l.getFullYear()+1);}}}}},e={changeMonth:function(i){switch(i.substr(0,3)){case"jan":return 0;case"feb":return 1;case"mar":return 2;
...
case"dec":return 11;default:return null;}},changeDay:function(l,j,i){var k=7-l.getDay()+j;if(k>7&&!i){k-=7;}l.setDate(l.getDate()+k);},escapeRegExp:function(i){return i.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&");
